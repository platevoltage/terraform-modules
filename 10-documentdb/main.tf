...
locals {
  active_cluster_id       = aws_docdb_cluster.fresh[0].id
  active_cluster_endpoint = aws_docdb_cluster.fresh[0].endpoint
  active_reader_endpoint  = aws_docdb_cluster.fresh[0].reader_endpoint
}
